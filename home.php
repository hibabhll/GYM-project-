    ...
    <div class="container">
      ...
      <div class="services-grid services-4">
        ...
        <div class="srv-card">
          <div class="srv-icon-wrap">
            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="24" cy="12" r="4" stroke="#c8f000" stroke-width="2.2"/>
              <path d="M16 28l4-8 4 4 4-10 4 6" stroke="#c8f000" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M10 36h28" stroke="#c8f000" stroke-width="2.2" stroke-linecap="round"/>
              <path d="M20 36v-4M28 36v-4" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <rect x="6" y="30" width="36" height="4" rx="2" stroke="#c8f000" stroke-width="1.5"/>
            </svg>
          </div>
          <h3>Cardio</h3>
        ...
        <div class="srv-card">
          <div class="srv-icon-wrap">
            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="14" y="8" width="16" height="22" rx="8" stroke="#c8f000" stroke-width="2.2"/>
              <path d="M14 20h16" stroke="#c8f000" stroke-width="1.8" stroke-linecap="round"/>
              <path d="M18 30v6a2 2 0 004 0v-6" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <path d="M26 30v6a2 2 0 004 0v-6" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <path d="M10 18h4M30 18h4" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
            </svg>
          </div>
          <h3>Boxe & MMA</h3>
        ...
        <div class="srv-card">
          <div class="srv-icon-wrap">
            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="24" cy="8" r="3.5" stroke="#c8f000" stroke-width="2.2"/>
              <path d="M24 12v10" stroke="#c8f000" stroke-width="2.2" stroke-linecap="round"/>
              <path d="M14 20c3 0 5 2 10 2s7-2 10-2" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <path d="M20 22l-6 8M28 22l6 8" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <path d="M24 22v14" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              <path d="M18 36h12" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
            </svg>
          </div>
        ...
        <div class="srv-card">
          <div class="srv-icon-wrap">
            <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="18" cy="12" r="5" stroke="#c8f000" stroke-width="2.2"/>
              <path d="M8 36c0-6 4-10 10-10s10 4 10 10" stroke="#c8f000" stroke-width="2.2" stroke-linecap="round"/>
              <circle cx="34" cy="18" r="3" stroke="#c8f000" stroke-width="1.8"/>
              <path d="M28 36c0-4 2-7 6-7" stroke="#c8f000" stroke-width="1.8" stroke-linecap="round"/>
              <path d="M32 10l2 2 5-5" stroke="#c8f000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
      ...
      <div class="trainers-grid">
        ...
        <div class="trainer-card">
          <div class="trainer-img-wrap">
            <img src="coache-mas.jpg" alt="Karim Mansouri"
              onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
            <div class="trainer-placeholder" style="display:none">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <circle cx="32" cy="24" r="14" stroke="#c8f000" stroke-width="2"/>
                <path d="M8 58c0-13 11-22 24-22s24 9 24 22" stroke="#c8f000" stroke-width="2" stroke-linecap="round"/>
              </svg>
            </div>
            <div class="trainer-overlay">
              <div class="trainer-socials">
                <a href="#" class="tsoc">in</a>
                <a href="#" class="tsoc">ig</a>
              </div>
            </div>
          ...
          <div class="trainer-body">
            ...
            <div class="trainer-stats">
              <span class="tstat"><svg width="13" height="13" viewBox="0 0 24 24" fill="#c8f000"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> 4.9</span>
              <span class="tstat">320 clients</span>
            </div>
          </div>
        </div>
        ...
        <div class="trainer-card">
          <div class="trainer-img-wrap">
            <img src="coache_mas2.jpg" alt="Yassine Trabelsi"
              onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
            <div class="trainer-placeholder" style="display:none">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <circle cx="32" cy="24" r="14" stroke="#c8f000" stroke-width="2"/>
          ...
          <div class="trainer-body">
            ...
            <div class="trainer-stats">
              <span class="tstat"><svg width="13" height="13" viewBox="0 0 24 24" fill="#c8f000"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> 4.9</span>
              <span class="tstat">195 clients</span>
            </div>
          </div>
        </div>
        ...
        <div class="trainer-card">
          <div class="trainer-img-wrap">
            <img src="coache-fem.jpg" alt="Nour Chouchane"
              onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
            <div class="trainer-placeholder" style="display:none">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <circle cx="32" cy="24" r="14" stroke="#c8f000" stroke-width="2"/>
          ...
          <div class="trainer-body">
            ...
            <div class="trainer-stats">
              <span class="tstat"><svg width="13" height="13" viewBox="0 0 24 24" fill="#c8f000"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> 5.0</span>
              <span class="tstat">240 clients</span>
            </div>
          </div>
        </div>
        ...
        <div class="trainer-card">
          <div class="trainer-img-wrap">
            <img src="coache_fem2.jpg" alt="Sarra Belhadj"
              onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"/>
            <div class="trainer-placeholder" style="display:none">
              <svg width="64" height="64" viewBox="0 0 64 64" fill="none">
                <circle cx="32" cy="24" r="14" stroke="#c8f000" stroke-width="2"/>
          ...
          <div class="trainer-body">
            ...
            <div class="trainer-stats">
              <span class="tstat"><svg width="13" height="13" viewBox="0 0 24 24" fill="#c8f000"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> 4.8</span>
              <span class="tstat">280 clients</span>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="gallery-grid">
        <div class="gal-item gal-tall">
          <img src="gym1.jpg" alt="Salle" onerror="this.parentElement.classList.add('gal-fallback');this.remove()"/>
          <div class="gal-fallback-inner"></div>
          <div class="gal-overlay"><span>Salle principale</span></div>
        </div>
        <div class="gal-item">
          <img src="gym2.jpg" alt="Cardio" onerror="this.parentElement.classList.add('gal-fallback');this.remove()"/>
          <div class="gal-fallback-inner"></div>
          <div class="gal-overlay"><span>Zone Cardio</span></div>
        </div>
        <div class="gal-item">
          <img src="gym3.jpg" alt="Boxe" onerror="this.parentElement.classList.add('gal-fallback');this.remove()"/>
          <div class="gal-fallback-inner"></div>
          <div class="gal-overlay"><span>Ring de Boxe</span></div>
        </div>
        <div class="gal-item gal-wide">
          <img src="gym4.jpg" alt="Yoga" onerror="this.parentElement.classList.add('gal-fallback');this.remove()"/>
          <div class="gal-fallback-inner"></div>
          <div class="gal-overlay"><span>Studio Yoga</span></div>
        </div>
        <div class="gal-item">
          <img src="gym5.jpg" alt="Coaching" onerror="this.parentElement.classList.add('gal-fallback');this.remove()"/>
          <div class="gal-fallback-inner"></div>
          <div class="gal-overlay"><span>Espace Coaching</span></div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="bmi-grid">
        ...
        <div class="bmi-form-wrap">
         ...
         <button onclick="window.location.href='BMI.php'">
  Calculer mon BMI
</button>
          </div>
        </div>
        ...
        <div class="bmi-result" id="bmiResult">
          <div class="bmi-result-inner">
            ...
            <div class="bmi-scale">
              <div class="bmi-scale-item bmi-thin">
                <span class="scale-dot"></span>
                <span class="scale-range">&lt; 18.5</span>
                <span class="scale-label">Insuffisant</span>
              </div>
              <div class="bmi-scale-item bmi-normal">
                <span class="scale-dot"></span>
                <span class="scale-range">18.5 – 24.9</span>
                <span class="scale-label">Normal</span>
              </div>
              <div class="bmi-scale-item bmi-over">
                <span class="scale-dot"></span>
                <span class="scale-range">25 – 29.9</span>
                <span class="scale-label">Surpoids</span>
              </div>
              <div class="bmi-scale-item bmi-obese">
                <span class="scale-dot"></span>
                <span class="scale-range">&gt; 30</span>
                <span class="scale-label">Obésité</span>
              </div>
            </div>
      ...
      <div class="pricing-grid pricing-2">
        ...
        <div class="price-card">
          <div class="price-head">
            ...
            <div class="price-amount">
              ...
              <span class="price-per">/mois</span>
            </div>
            <p class="price-desc">Idéal pour débuter et découvrir ADRENA à ton rythme.</p>
          </div>
          <ul class="price-features">
            <li class="yes">Accès salle 6h–23h</li>
            <li class="yes">Zone Cardio complète</li>
            <li class="yes">Vestiaires & douches</li>
            <li class="yes">Application mobile</li>
            <li class="yes">Parking gratuit</li>
            <li class="no">Cours collectifs (Boxe / Yoga)</li>
            <li class="no">Coaching personnalisé</li>
            <li class="no">Accès prioritaire aux créneaux</li>
          </ul>
        ...
        <div class="price-card price-featured">
          ...
          <ul class="price-features">
            ...
            <li class="yes">Application mobile</li>
            <li class="yes">Parking gratuit</li>
            <li class="yes">Cours collectifs illimités (Boxe / Yoga)</li>
            <li class="yes">2 séances coaching personnalisé/mois</li>
            <li class="yes">Accès prioritaire aux créneaux</li>
          </ul>
      ...
      <div class="contact-grid">
        <div class="contact-info">
          <div class="info-item">
            ...
            <div><h4>Adresse</h4><p>Rue du Lac Léman, Les Berges du Lac<br/>Tunis 1053, Tunisie</p></div>
          </div>
          <div class="info-item">
            <div class="info-icon">🕐</div>
            <div><h4>Horaires</h4><p>Lundi – Vendredi : 06h00 – 23h00<br/>Samedi – Dimanche : 08h00 – 22h00</p></div>
          </div>
          <div class="info-item">
            <div class="info-icon">📞</div>
            <div><h4>Téléphone</h4><p>+216 71 000 000</p></div>
          </div>
          <div class="info-item">
            <div class="info-icon">✉️</div>
            <div><h4>Email</h4><p>contact@adrena-gym.tn</p></div>
          </div>
        ...
        <div class="map-wrap">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3193.2!2d10.2272!3d36.8325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzbCsDQ5JzU3LjAiTiAxMMKwMTMnMzguMCJF!5e0!3m2!1sfr!2stn!4v1234567890"
            allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="ADRENA">
          </iframe>
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <div class="footer-socials">
            <a href="#" class="fsoc">fb</a><a href="#" class="fsoc">ig</a>
            <a href="#" class="fsoc">yt</a><a href="#" class="fsoc">tk</a>
          </div>
        </div>
        <div class="footer-col">
          ...
          <a href="#pricing">Tarifs</a><a href="shop.php">Shop</a>
